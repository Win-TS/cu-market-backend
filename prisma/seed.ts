...
async function seed() {
  try {
    ...
    const products = [
      { productName: 'Intania Music Fest', description: 'Free Food and Entry', quantity: 100, startPrice: 200, available: false, studentId: '1231', address: 'ise', expiryTime: addHr, image: imgEx1 },
      ...
      { productName: 'Borrow iPad', description: '1-day borrow', startPrice: 300, quantity: 10, available: true, studentId: '1231', address: 'bba', expiryTime: addHr },
      { productName: 'Starbucks Table', description: '3 tables', startPrice: 560, quantity: 15, available: true, studentId: '1232', address: 'eba', expiryTime: addHr, image: imgEx },
      { productName: 'Library Room', description: 'Room A floor 3', startPrice: 9000, quantity: 20, endPrice: 28000, available: false, studentId: '1232', address: 'bba', expiryTime: now, buyerId: '1236', image: imgEx },
      { productName: 'Food court queue', description: 'i-Canteen 2 floor', startPrice: 700, quantity:50, available: true, studentId: '1231', address: 'ise', expiryTime: addHr },
      { productName: 'Com Pres Eng Slot', description: 'Sec 5', startPrice: 5000, quantity: 100, available: false, studentId: '1235', address: 'inda', expiryTime: now, image: imgEx1 },
      { productName: 'Doing Homework', description: 'Year 1, Calculus or Physics', startPrice: 2500, quantity: 10, available: true, studentId: '1234', address: 'balac', expiryTime: addHr },
      { productName: 'Queue Taker', description: 'Any place in CU', startPrice: 1000, quantity: 1000, endPrice: 5500, available: false, studentId: '1237', address: 'CU', expiryTime: now, buyerId: '1238' },
      { productName: 'Tim Hortos Table', description: '1 Table, 2 Seats', startPrice: 1500, quantity: 500, available: true, studentId: '1239', address: 'ise', expiryTime: addHr, image: imgEx },
